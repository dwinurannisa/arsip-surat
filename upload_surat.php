...
<div class="container-fluid">
    <div class="row">
        ...
        <main class="col-md-10 ms-sm-auto px-md-4 py-4">
            ...
            <!-- Form Upload -->
            <form id="uploadForm" action="upload_excel.php" method="post" enctype="multipart/form-data" class="mb-4">
                <div class="mb-3">
                    <label for="file" class="form-label">Upload Surat Excel</label>
                    ...
                    <table id="suratTable" class="table table-hover align-middle">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <?php else: ?>
                                    <select class="form-select" onchange="updateBidang(this, <?= $row['id'] ?>)">
                                        <option value="">- Pilih -</option>
                                        <option value="Bidang I" <?= $row['bidang'] == 'Bidang I' ? 'selected' : '' ?>>Bidang I</option>
                                        <option value="Bidang II" <?= $row['bidang'] == 'Bidang II' ? 'selected' : '' ?>>Bidang II</option>
                                        <option value="Bidang III" <?= $row['bidang'] == 'Bidang III' ? 'selected' : '' ?>>Bidang III</option>
                                        <option value="Bidang IV" <?= $row['bidang'] == 'Bidang IV' ? 'selected' : '' ?>>Bidang IV</option>
                                    </select>
                                <?php endif; ?>
                            </td>
                            <td>
                                ...
                                <?php else: ?>
                                    <select class="form-select" onchange="updateStatus(this, <?= $row['id'] ?>)">
                                        <option value="">- Pilih -</option>
    ...
    function updateStatus(selectElement, id) {
        ...
        .then(data => {
            if (data.success) {
                ...
                if (status === 'Diterima') {
                    selectElement.innerHTML = '<option selected disabled>Diterima</option>';
